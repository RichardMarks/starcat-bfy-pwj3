...
EXEC_PATH="./bin/starcatbfy"
APP_NAME="StarcatBFYJamEdition"
...
hdiutil create -size 20m -fs HFS+ -volname "Starcat BFY Jam Edition" -srcfolder ./dmg/image -format UDZO -o ./dmg/$APP_NAME-OSX.dmg
